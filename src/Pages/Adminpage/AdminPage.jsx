...
import { Package, TrendingUp, AlertCircle, DollarSign, Users, ShoppingCart, ArrowRight, BarChart3, Home, Menu, X, LogOut, Settings } from 'lucide-react';
...
const AdminHomepage = () => {
  ...
  return (
    <div className="flex min-h-screen bg-gradient-to-br from-amber-50 to-orange-100">
      ...
      <aside className={`${sidebarOpen ? 'w-64' : 'w-20'} bg-amber-900 text-white transition-all duration-300 flex flex-col`}>
        {/* Logo & Toggle */}
        ...
        <nav className="flex-1 p-4 space-y-2">
          {sidebarOpen ? (
            ...
            <div className="space-y-4">
              <a href="/admin" className="flex justify-center p-3 bg-amber-700 rounded-lg">
                <Home size={20} />
              </a>
              <a href="/admin/products" className="flex justify-center p-3 hover:bg-amber-800 rounded-lg">
                <Package size={20} />
              </a>
              <a href="/admin/orders" className="flex justify-center p-3 hover:bg-amber-800 rounded-lg">
                <ShoppingCart size={20} />
              </a>
              <a href="/admin/customers" className="flex justify-center p-3 hover:bg-amber-800 rounded-lg">
                <Users size={20} />
              </a>
              <a href="/admin/analytics" className="flex justify-center p-3 hover:bg-amber-800 rounded-lg">
                <BarChart3 size={20} />
              </a>
              <a href="/admin/settings" className="flex justify-center p-3 hover:bg-amber-800 rounded-lg">
                <Settings size={20} />
              </a>
            </div>
          )}
                ...
                {recentActivity.map((activity) => (
                  <div key={activity.id} className="flex items-start gap-4 pb-4 border-b border-gray-200 last:border-0">
                    <div className={`p-2 rounded-lg ${
                      ...
                      {activity.type === 'order' ? <ShoppingCart size={20} className="text-green-600" /> :
                       activity.type === 'stock' ? <AlertCircle size={20} className="text-red-600" /> :
